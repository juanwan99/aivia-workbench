...
| **产品 CLAIM** | **[CLAIM-GENERAL-WB=YES](./ops/S2-GENERAL-WB-REPORT.md)**（G4–G7 双轨） |
| **刀序** | [ops/TASK-CARD-NOW.md](./ops/TASK-CARD-NOW.md) |
| **已收** | S1 FULL · S1.1 · **S2** |
| **下一刀** | S3 体感对齐 或 S4 能力加厚 |
...
| **证据** | [s1](./ops/evidence/general-wb/s1/) · [s1.1](./ops/evidence/general-wb/s1.1/) · [s2](./ops/evidence/general-wb/s2/) |

> 根域 `asyncova.com/` ≠ 工作台；Chat 须写全路径。  
> CLAIM-GENERAL-WB = 行为级跨领域真交付 · ≠ 像素抄 · ≠ 上线扩权。
