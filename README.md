...
| **产品 CLAIM** | **[CLAIM-GENERAL-WB=FULL YES](./ops/S2.1-HOTFIX-REPORT.md)** · **[CLAIM-S3-UX=YES](./ops/S3-UX-REPORT.md)** |
| **刀序** | [ops/TASK-CARD-NOW.md](./ops/TASK-CARD-NOW.md) |
| **已收** | S1 FULL · S1.1 · S2 · S2.1 · **S3-UX** |
| **下一刀** | S4 能力加厚 或 业主点名 |
...
| **证据** | [s1](./ops/evidence/general-wb/s1/) · [s1.1](./ops/evidence/general-wb/s1.1/) · [s2](./ops/evidence/general-wb/s2/) · [s2.1](./ops/evidence/general-wb/s2.1/) · [s3](./ops/evidence/general-wb/s3/) |

> 根域 `asyncova.com/` ≠ 工作台；Chat 须写全路径。  
> 行为对标 WorkBuddy · ≠ 像素抄 · ≠ 备案完成 · ≠ 上线扩权。
