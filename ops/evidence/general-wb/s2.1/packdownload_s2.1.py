# Aivia PackDownload · GENERAL-WB defaults (S2.1)
...
# Source lineage: ops/evidence/wb-fix-deploy/packdownload_fixed.py
...
def main(llm_text: str) -> dict:
    ...
    if want_docx and md and not re.search(r"```html", text, re.I):
        filename = _safe_name(fm_docx.group(1) if fm_docx else "文档.docx", "文档.docx", ".docx")
